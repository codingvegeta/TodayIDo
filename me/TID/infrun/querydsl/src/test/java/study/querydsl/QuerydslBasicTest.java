...
//                .fetch();
//
//        Member fetchMember = queryFactory.selectFrom(member)
//                .fetchOne();
//
...
//                .where(team.name.eq("teamA"))
    ...
    public void dynamicQuery_BooleanBuilder() {
        String usernamePara = "member1";
        Integer agePram = null;

        List<Member> result = searchMember1(usernamePara, agePram);
    ...
    public void dynamicQuery_WhereParam() {
        ...
        List<Member> result = searchMember2(usernamePara, agePram);
        assertThat(result.size()).isEqualTo(1);
    }
